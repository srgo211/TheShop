namespace TelegramBotProject.Settings;
...
public static class TextComands
{
    ...
    public const string prevProductBtn = "PREV";
    public const string nextProductBtn = "NEXT";
    public const string backBtn = "Назад";
    public const string addOrderBtn = "В корзину";
